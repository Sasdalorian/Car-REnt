...
public class MainGUI extends JFrame {
    ...
    private JTextField txtCliente, txtDias, txtPatente, txtMarca, txtModelo;
    ...
    public MainGUI() {
        ...
        JButton boton2 = new JButton("Arrendar en Cuotas");
        ...
        vista1.add(new JLabel("CLIENTES"));

        JPanel vista2 = new JPanel();
        vista2.setBackground(Color.BLACK);
        vista2.add(new JLabel("ARRIENDOS CON CUOTA"));

        JPanel vista3 = new JPanel();
        vista3.setBackground(Color.YELLOW);
        vista3.add(new JLabel("PAGAR CUOTAS DE ARRIENDOS"));
